...
export function MenuBarDemo() {
  ...
  return (
    <div ref={rootRef} className="relative mx-auto w-full max-w-2xl">
      <div className="rounded-lg bg-zinc-950 p-1.5 shadow-2xl shadow-zinc-950/20 ring-1 ring-zinc-950/10">
        <div className="flex h-12 items-center justify-between gap-3 rounded-md bg-zinc-900 px-3 text-base/7 text-zinc-300 sm:text-sm/6">
          <div className="flex min-w-0 items-center gap-4">
            <span className="font-semibold text-white">nodoze</span>
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <Search className="size-5 text-zinc-400 sm:size-4" aria-hidden="true" />
            <Wifi className="size-5 text-zinc-400 sm:size-4" aria-hidden="true" />
            <BatteryFull className="size-5 text-zinc-400 sm:size-4" aria-hidden="true" />
      ...
      {menuOpen ? (
        <div className="absolute top-14 right-1 z-20 w-64 rounded-lg bg-zinc-100 p-2 text-zinc-950 shadow-xl shadow-zinc-950/20 ring-1 ring-zinc-950/10">
          ...
          >
            <span>Settings</span>
            <Settings className="size-5 text-zinc-500 sm:size-4" aria-hidden="true" />
          </button>
          <button
            type="button"
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-zinc-950/35 p-5">
          <div className="w-full max-w-sm rounded-lg bg-[#f7f7f4] p-5 shadow-2xl shadow-zinc-950/30 ring-1 ring-zinc-950/10">
            ...
            <div className="mt-3 space-y-1 text-base/7 text-zinc-700 sm:text-sm/6">
              <p>Version 0.1.0</p>
              <p>Built by 74Lab.</p>
              <p>Developer ID signed and Apple notarized for macOS.</p>
            </div>
          </div>
        </div>
      ) : null}
